...
- Tests coverage for statements is 89%.
- RTK query is used for fetching and cache data.
- The application has a dark theme.
- It's possible to download as csv checked items.
